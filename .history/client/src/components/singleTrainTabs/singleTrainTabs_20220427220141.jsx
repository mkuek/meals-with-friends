...
const SingleTrainTabs = ({ trainInfo }) => {
  const [parentVale, setParentValue] = useState(0);
    ...
    <Box sx={{ flexGrow: 1 }}>
      ...
      >
        <Box sx={{ width: "100%" }}>
          ...
          <TabPanel value={parentVale} index={0}>
            <div>
                            ...
                            >
                              ...
                              <TabPanel value={innerTabValue} index={1}>
                                <div className="calendar">
                                  ...
                                  <Grid container className="calendar" width={100%}>
                                    <Grid item xs={9}>
                                      <FullCalendar
          ...
          <TabPanel value={parentVale} index={1}>
            empty
          </TabPanel>
          <TabPanel value={parentVale} index={2}>
            <form action="">
              <Grid container spacing={1}>
                <Grid item xs={6}></Grid>
                <Grid item xs={6}></Grid>
