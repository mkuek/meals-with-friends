...
const SingleTrainTabs = ({ trainInfo }) => {
  ...
  const handleOpenModal = (data) => setOpenModal({ open: true, data: data });
  const handleCloseModal = () => setOpenModal({ open: false, data: "" });
                              ...
                              >
                                ...
                                >
                                  <Button
                                    ...
                                    sx={{ gap: "0.25rem" }}
                                    onClick={(e) => {
                                      openModal.open == false && e.target
                                        ? handleOpenModal(trainInfo)
                                        : handleCloseModal();
                                    }}
                                  >
