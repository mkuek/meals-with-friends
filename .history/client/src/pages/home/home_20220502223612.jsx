        ...
        onScroll={(e) => {
          for (let i = 0; i <= trackIds.length - 1; i++) {
            ...
            if (
              ...
              window.scrollTo(0, trackedEl.offsetHeight);
            }
            console.log(trackedEl.offsetHeight);
          }
        }}
      >
        {children}
    ...
    <>
      ...
      <Scroller
        ...
        onScrollToElement={(el) => {
          console.log(el.id === "card-1");
          if (el.id === "card-1" && !showCard1) {
            setShowCard1(true);
          }
          if (el.id === "card-2" && !showCard2) {
            setShowCard2(true);
          }
          if (el.id === "card-3" && !showCard3) {
            setShowCard3(true);
            setShowCard4(true);
          }
          if (el.id === "card-4" && !showCard4) {
            setShowCard4(true);
          }
        }}
      >
