...
const EditVolunteer = () => {
  ...
  const [formContents, setFormContents] = useState({
    meals: trainInfo.individual_meals[mealId].meal_name,
  });
  ...
  const getData = async () => {
    ...
    setFormContents({
      meal: querySnapshot.data().individual_meals[mealId].meal_name,
    });
  };
                    ...
                    <Grid item xs={9}>
                      ...
                      <TextField
                        ...
                        value={
                          ...
                          trainInfo.individual_meals[mealId].meal_name
                        }
                      />
                    </Grid>
                    <Grid item xs={9}>
                      ...
                      <TextField
                        ...
                        value={
                          trainInfo.individual_meals &&
                          trainInfo.individual_meals[mealId].notes
                        }
                      />
                    </Grid>
                    <Grid item xs={9}>
