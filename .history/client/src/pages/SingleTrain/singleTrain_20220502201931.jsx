...
import { Button, Chip, Slide, Typography } from "@mui/material";
          ...
          <div className="body">
            ...
            <div className="right">
              ...
              <Slide
                in={true}
                direction="left"
                easing={{ { enter: theme.transitions.duration.enteringScreen, exit: theme.transitions.duration.leavingScreen, }}}
              >
                <div className="body">
                  {trainInfo && (
                    <SingleTrainTabs
