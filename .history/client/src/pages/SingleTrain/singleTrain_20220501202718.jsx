...
const SingleTrain = () => {
  ...
  const getData = async () => {
    ...
    if (querySnapshot.exists()) {
      ...
      const startDate =
        moment(
          `${querySnapshot.data().meal_date_start[0].year}-${
            querySnapshot.data().meal_date_start[0].month
          }-${querySnapshot.data().meal_date_start[0].day - 1}`,
          "YYYY-M-D"
        ) || moment().format("YYYY-M-D");
      const endDate =
        moment(
          `${querySnapshot.data().meal_date_end[0].year}-${
            querySnapshot.data().meal_date_end[0].month
          }-${querySnapshot.data().meal_date_end[0].day + 1}`,
          "YYYY-M-D"
        ) || moment().format("YYYY-M-D");
